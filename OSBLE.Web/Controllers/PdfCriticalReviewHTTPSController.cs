...
#endif
    /// <summary>
    /// using this to handle resubmission which requires https to function properly... should work because we are not actually loading annotate (which requires http)
    /// </summary>
    public class PdfCriticalReviewHTTPSController : OSBLEController
    {

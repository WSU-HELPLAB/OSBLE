var meetingTemplate= '\
        <div class="meeting_time" id="meeting_time_${count}">\
            ...
            <tr>\
                <td>Set Local TimeZone</td>\
                <td>\
                <br />\
                <select id="timezone_data" name="meeting_timezone">\
                ...
                <span class="field-validation-valid" data-valmsg-for="meeting_timezone_${count}" data-valmsg-replace="true"></span>\
                </td>\
            </tr>\
            \
            </table>\

...
namespace FileUploader.OsbleServices {
    ...
    public interface UploaderWebService {
        ...
        System.IAsyncResult BeginPrepCurrentPath(FileUploader.OsbleServices.DirectoryListing dirList, string relative, int courseId, string authToken, System.AsyncCallback callback, object asyncState);
    ...
    public partial class UploaderWebServiceClient : System.ServiceModel.ClientBase<FileUploader.OsbleServices.UploaderWebService>, FileUploader.OsbleServices.UploaderWebService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult FileUploader.OsbleServices.UploaderWebService.BeginPrepCurrentPath(FileUploader.OsbleServices.DirectoryListing dirList, string relative, int courseId, string authToken, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginPrepCurrentPath(dirList, relative, courseId, authToken, callback, asyncState);
        }
        ...
        private System.IAsyncResult OnBeginPrepCurrentPath(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            string relative = ((string)(inValues[1]));
            int courseId = ((int)(inValues[2]));
            string authToken = ((string)(inValues[3]));
            return ((FileUploader.OsbleServices.UploaderWebService)(this)).BeginPrepCurrentPath(dirList, relative, courseId, authToken, callback, asyncState);
        }
        ...
        public void PrepCurrentPathAsync(FileUploader.OsbleServices.DirectoryListing dirList, string relative, int courseId, string authToken) {
            this.PrepCurrentPathAsync(dirList, relative, courseId, authToken, null);
        }
        
        public void PrepCurrentPathAsync(FileUploader.OsbleServices.DirectoryListing dirList, string relative, int courseId, string authToken, object userState) {
        ...
        private class UploaderWebServiceClientChannel : ChannelBase<FileUploader.OsbleServices.UploaderWebService>, FileUploader.OsbleServices.UploaderWebService {
            ...
            public System.IAsyncResult BeginPrepCurrentPath(FileUploader.OsbleServices.DirectoryListing dirList, string relative, int courseId, string authToken, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[4];
                _args[0] = dirList;
                _args[1] = relative;
                _args[2] = courseId;

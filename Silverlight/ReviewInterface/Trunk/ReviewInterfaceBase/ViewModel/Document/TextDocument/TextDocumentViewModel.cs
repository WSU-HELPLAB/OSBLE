...
namespace ReviewInterfaceBase.ViewModel.Document.TextFileDocument
{
    public class TextDocumentViewModel : ISpatialDocumentViewModel
    {
        ...
        public ISpatialLocation GetReferenceLocationFromXml(XElement location)
        {
            ...
            return new DocumentLocation(textStartPtr, textEndPtr, new Tuple<int, int>(textStartLine, textStartIndex), new Tuple<int, int>(textEndLine, textEndIndex));
        }
        ...
        {
            selectionHighlighting.TextStart = (referenceLocation as DocumentLocation).LocationStart;
            selectionHighlighting.TextEnd = (referenceLocation as DocumentLocation).LocationEnd;
            selectionHighlighting.ContentStart = thisView.DocumentViewer.ContentStart;
            selectionHighlighting.Canvas = HighlightOverlay;
        ...
        public ISpatialLocation GetReferenceLocation()
        {
            ...
            {
                return new DocumentLocation(thisView.DocumentViewer.Selection, findContentLineNumber(thisView.DocumentViewer.Selection.Start), findContentLineNumber(thisView.DocumentViewer.Selection.End));
            }
            else
            {
                return null;

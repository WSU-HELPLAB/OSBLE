...
namespace ReviewInterfaceBase.ViewModel.Comment2
{
    public class AuthorRebuttalCommentViewModel : AbstractCommentViewModel
    {
        ...
        public AuthorRebuttalCommentViewModel(XElement xmlComment, NoteAuthor author, ILocation location)
        {
        ...
        private void initlizeCommentFromXmlComment(XElement xmlComment, NoteAuthor author)
        {
            ...
            // thisModel.ID = int.Parse(xmlComment.Attribute("ID").Value);
        ...
        public override void XmlWrite(XmlWriter writer)
        {
            ...
            issueVotingCategories.WriteXml(writer);
        }

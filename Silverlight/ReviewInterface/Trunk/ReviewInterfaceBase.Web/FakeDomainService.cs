namespace ReviewInterfaceBase.Web
{
    ...
    public class FakeDomainService : DomainService
    {
        ...
        {
            return new List<DocumentLocation>() { new DocumentLocation("", 200, "Anonymous", AuthorClassification.Student) }.AsQueryable();
        }

        public IQueryable<DocumentLocation> GetPeerReviewLocations()
        {
            return (new List<DocumentLocation>() { new DocumentLocation("PeerReview5.xml", 100, "Anonymous", AuthorClassification.Student),

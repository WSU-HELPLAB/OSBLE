...
namespace OSBLE.Areas.AssignmentWizard.Controllers
{
    public class PreviousAssignmentController : WizardBaseController
    {
        ...
        public override ICollection<AssignmentTypes> ValidAssignmentTypes
        {
            get 
            {
                return (new AssignmentTypes[] { AssignmentTypes.CriticalReview, AssignmentTypes.TeamEvaluation, AssignmentTypes.CriticalReviewDiscussion, AssignmentTypes.AnchoredDiscussion }).ToList();
            }
        }
